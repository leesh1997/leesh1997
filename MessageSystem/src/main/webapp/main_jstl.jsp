							...
							<c:choose>
								...
								<c:otherwise>
									<c:forEach var="msg" items="${msglist}">
										<li><strong>보낸 사람 : ${msg.m_sendName}</strong><br> <strong>내용
												: ${msg.m_content}</strong><br> <strong>날짜 :
												${msg.m_sendDate}</strong><br> <a
											href="MsgDeleteCon?num=${msg.m_num}">삭제</a></li>
									</c:forEach>
									<li><a href="MsgDeleteAllCon" class="button next scrolly">전체삭제하기</a>
									</li>
								</c:otherwise>
							</c:choose>
						</c:otherwise>

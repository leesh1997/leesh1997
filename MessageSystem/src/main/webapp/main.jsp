...
<body>
	...
	<div id="wrapper">
	 ...
	 %> <a href="MemberSelectAllCon.do">회원관리</a> <a href="logout.jsp">로그아웃</a> <%
 } else {
			...
			<div class="inner">
				...
				<ul class="actions">
					...
					if(member == null){
						...
						if (msglist.isEmpty()) {
							out.print("<li>받은 메세지가 없어유.</li>");
						} else {
							for(int i=0; i<msglist.size(); i++){
								out.print("<li>");
								out.print("<string>보낸 사람</strong>:"+msglist.get(i).getM_sendName()+"<br>");
								out.print("<string>내용</strong>:"+msglist.get(i).getM_content()+"<br>");
								out.print("<string>날짜</strong>:"+ msglist.get(i).getM_sendDate() +"<br>");
			...
			<form action="MsgSendCon" method="post">
				<div class="field half first">
					<label for="name">Name</label> <input type="text" id="name"
						name="name" placeholder="보내는 사람 이름" />
				</div>
				<div class="field half">
					<label for="email">Email</label> <input type="text" id="email"
						name="email" placeholder="보낼 사람 이메일" />
				</div>
				<div class="field">
